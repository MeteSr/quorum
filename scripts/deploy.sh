...
# ── Canister deployment ───────────────────────────────────────────────────────
CANISTERS=(members governance treasury documents announcements maintenance violations)
...
try:
    ...
    existing = {}
for name in ["members","governance","treasury","documents","announcements","maintenance","violations","frontend"]:
