...
# ── Canister deployment ───────────────────────────────────────────────────────
CANISTERS=(members governance treasury documents announcements maintenance violations meetings calendar arc parking)
...
try:
    ...
    existing = {}
for name in ["members","governance","treasury","documents","announcements","maintenance","violations","meetings","calendar","arc","parking","frontend"]:
