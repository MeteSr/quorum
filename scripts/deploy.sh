...
# ── Canister deployment ───────────────────────────────────────────────────────
CANISTERS=(members governance treasury documents announcements maintenance violations meetings calendar arc parking vendors discussions amenities marketplace benefit)
...
ids = {}
for name in ["members","governance","treasury","documents","announcements","maintenance","violations","meetings","calendar","arc","parking","vendors","discussions","amenities","marketplace","benefit"]:
...
try:
    ...
    existing = {}
for name in ["members","governance","treasury","documents","announcements","maintenance","violations","meetings","calendar","arc","parking","vendors","discussions","amenities","marketplace","benefit","frontend"]:
